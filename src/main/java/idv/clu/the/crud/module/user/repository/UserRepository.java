...
public interface UserRepository {
    ...
    @Insert("INSERT INTO USER(username, password, first_name, last_name, birthday, age, gender, registration_date, is_admin, "
            + "is_vip, is_test, is_suspended) "
            + "VALUES(#{username}, #{password}, #{firstName}, #{lastName}, #{birthday}, #{age}, #{gender}, #{registrationDate},"
            + " #{isAdmin}, #{isVip}, #{isTest}, #{isSuspended})")
